...
# #handles case of filler letter repeatation X
...
#             i += 2
#         else:
#             prepared_text += text[i] + "X" if text[i] != "X" else text[i] + "Q"
#             i += 1
#     if len(prepared_text) % 2 != 0:
#         prepared_text += "X" if prepared_text[-1] != "X" else "Q"
#     print(f"Modified text: {prepared_text}")
#     return prepared_text
def remove_special_characters(string):
    # Remove commas, full stops, and other special characters
