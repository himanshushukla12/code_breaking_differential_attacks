...
MAX_KEY_LENGTH = 7 # will not attempt keys longer than this
...
DeprecationWarning
def main():
    #ciphertext = """vpxz ka rhwatk dg dbt xgvlmra izdbr uttdmgz  oiiogupakkxhp, tdnkkxhp, kgfrbpuctnzv, ick ewbwwbty ukxlpbxzv. Pt dca wpipaf kvuswmcakia"""
    #hackedMessage = hackVigenere(ciphertext)
    hackedMessage = hackVigenere(sys.argv[1])
...
if __name__ == '__main__':
    assign("iaf g xalye tmt sougrr gbp dvj bat vsddefy jushgzxy ny o yaa jshogkr fo vthqlykqfunr szdrgjauey. Czcr, gh m sposztvlwo cbtudefy, vq wrth fo gns togkz ihrxs fhr vfafrygarf csde uuzpiam o eopoox aslour. Uk qtepqsp ia nwe cbgh mnq vfacrkrqd gukmrqy hte cxcrefycds' eucy. Tuk qxonqfaoz ghfeajozt egb mfgkf tiz gbp pbobfeq zc mnbzvqr eucy snewzg")
    #main()